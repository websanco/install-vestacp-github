...
function StartTheProcess()
{
	...
	# ---------------------------------
		...
		bash vst-install.sh --nginx yes --phpfpm yes --apache no --vsftpd yes --proftpd no --exim yes --dovecot yes --spamassassin yes --clamav no --named yes --iptables no --fail2ban no --mysql yes --postgresql no --remi yes --quota no --hostname $vHostname --email $vEmail --password $vPassword
